 ...
 * 
 */
public class CompareimagesSimilarity {
	// 改变成二进制码
	...
	public static void compareImage(String imgPath1, String imgPath2) {
		...
		if (images.length == 0) {
			System.out.println("Usage >java image ImageFile.bmp");
			System.exit(0);
		}
	...
	public static void main(String[] args) {
		// for (int i = 1; i <= 2; i++) {
		// image.compareImage("F:/1.jpg", "F:/img/" + i + ".jpg");
		// }
		CompareimagesSimilarity.compareImage("F:/1.jpg", "F:/7.jpg");
